    ...
    <section id="home" className="scroll-mt-24 relative flex flex-col items-center justify-center min-h-[90vh] py-20 px-4 overflow-hidden bg-gradient-to-br from-white via-blue-50 to-fuchsia-50">
      ...
      >
        <h1 className="sr-only">
          Web Development Agency in Meerut, India | Jaat Entrepreneurs
        </h1>
        ...
        <p className="max-w-2xl text-lg sm:text-xl text-gray-600 mb-8">
          Jaat Entrepreneurs is a leading web development agency in Meerut, and across India. We craft modern software solutions for ambitious brands, helping businesses establish a strong online presence with custom website design, e-commerce solutions, and digital marketing services.
        </p>
